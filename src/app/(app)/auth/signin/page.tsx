          ...
          <div className="relative rounded-[15px] bg-black/70 border border-white/10 backdrop-blur-xl p-8">
            ...
            <div className="space-y-4">
              <motion.button
                ...
                className="w-full group relative overflow-hidden rounded-lg border border-white/15 bg-white/5 px-4 py-3 flex items-center justify-center gap-3 text-sm font-medium text-white transition disabled:opacity-60 disabled:cursor-not-allowed"
                aria-busy={isLoading}
              >
                <Image
                  src="/google-icon.svg"
            ...
            <div className="mt-8 text-[11px] text-neutral-400 leading-relaxed space-y-2">
              ...
              <p className="text-neutral-500">
                Need an account? Just continue with Google — we create it
                automatically.
              </p>
            </div>
          </div>
