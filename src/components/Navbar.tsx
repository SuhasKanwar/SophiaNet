      ...
      <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
        ...
        >
          ...
          <div className="w-5 h-5 relative">
            <span
              className={`absolute inset-x-0 top-1 block h-0.5 bg-white transition-transform ${
                open ? "translate-y-2 rotate-45" : ""
              }`}
            />
            <span
              className={`absolute inset-x-0 top-2.5 block h-0.5 bg-white transition-opacity ${
                open ? "opacity-0" : ""
              }`}
            />
            <span
              className={`absolute inset-x-0 top-4 block h-0.5 bg-white transition-transform ${
                open ? "-translate-y-2 -rotate-45" : ""
              }`}
            />
          </div>
        ...
        <div className="flex items-center gap-4">
          {!session && (
            <button
              ...
              className="relative overflow-hidden rounded-md px-4 py-2 text-sm font-medium bg-black border border-indigo-400 text-white hover:bg-indigo-500/10 focus:outline-none focus:ring-2 focus:ring-indigo-400/60 transition"
            >
              ...
              <div ref={userMenuRef} className="relative">
                ...
                >
                  <div className="relative w-10 h-10 rounded-full overflow-hidden border border-white/15 bg-white/5 hover:border-indigo-400/60 transition">
                    ...
                    <div
                      className={`absolute inset-0 rounded-full ring-2 ring-indigo-400/0 group-hover:ring-indigo-400/50 transition`}
                    />
                  </div>
                  ...
                  >
                    <div className="relative p-[1.5px] rounded-2xl bg-gradient-to-br from-white/25 via-white/10 to-transparent backdrop-blur">
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "radial-gradient(circle at 30% 20%, rgba(129,140,248,0.35), transparent 65%)",
                        }}
                      />
            ...
            {session && (
              <li>
                <button
                  ...
                  className="w-full text-left px-1 py-1 rounded hover:bg-white/10 border border-indigo-400 bg-black"
                >
                  Chatbot
                </button>
              </li>
            ...
            {!session && (
              <li>
                <button
                  ...
                  className="w-full text-left px-1 py-1 rounded hover:bg-indigo-500/10 border border-indigo-400 bg-black"
                >
                  Sign In
                </button>
              </li>
